...
const poolGroup: GuideGroup = {
  ...
  description: "Poolbau mit aktuellen 2026-Richtwerten für GFK-, Beton-, Styropor- und Edelstahlpools, direkten GFK-vs.-Beton-Vergleich, Erdarbeiten sowie laufende Poolkosten planen und vergleichen.",
  slugs: [
    "pool-bauen-kosten",
    "gfk-pool-kosten",
    "betonpool-kosten",
